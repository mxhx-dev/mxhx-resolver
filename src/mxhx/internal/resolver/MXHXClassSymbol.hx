...
class MXHXClassSymbol extends MXHXTypeSymbol implements IMXHXClassSymbol {
	...
	public function new(name:String, ?pack:Array<String>, ?params:Array<IMXHXTypeSymbol>, ?superClass:IMXHXClassSymbol, ?fields:Array<IMXHXFieldSymbol>,
			?events:Array<IMXHXEventSymbol>, ?defaultProperty:String) {
